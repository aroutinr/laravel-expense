...
<body>
	<header class="clearfix">
		...
		<div id="payment-details">
			...
			<p>Currency: <strong>{{ $payment->expense->currency }}</strong></p>
		</div>
	</header>
	<main>
		@isset ($payment->expense->number)
			<h1>Payment to Expense # {{ $payment->expense->number }}</h1>
		@endisset
